...
Boring Analytics is a pragmatic modular monolith. It uses business capability slices, separates framework-facing delivery from application code, and separates command models from read models.
